...
export class LifeEventService {
  ...
  getRandomEvent(roll: number): string {
    if (roll <= 10) {
      ...
      return `You made an enemy of an adventurer. You are ${toBlame ? 'not' : ''} to blame for making them your enemy.` +
        'Use the supplemental tables and work with your DM to determine this hostile character\'s identity ' +
        'and the danger this enemy poses to you.';
    } else if (roll <= 50) {
      return 'You made a friend of an adventurer. Use the supplemental tables and work with your DM to add more detail to this friendly ' +
      'character and establish how your friendship began.';
    } else if (roll <= 70) {
      ...
      return 'You met someone important. Use the supplemental tables to determine this character\'s identity and how this individual ' +
        'feels about you. Work out additional details with your DM as needed to fit this character into your backstory.';
    } else if (roll <= 80) {
      ...
      return 'You fought in a battle. Roll on the War table to leafn what happened to you. Work with your DM to come up with the reason ' +
        'for the battle and the factions involved. It might have been a small conflict between your community and a band oforcs, or it ' +
        'could have been a major battle in a larger war.';
    } else if (roll <= 95) {
      return 'You committed a crime or were wrongly accused of doing so. Roll on the Crime table to determine the nature of the offense ' +
        'and on the Punishment table to see what became of you.';
    } else if (roll <= 99) {
  ...
  getRandomTragedy(): string {
    ...
    if (roll <= 2) {
      ...
      return 'You were imprisoned for a crime you didn’t commit and spent 1d6 years at hard labor, in jail, or shackled to an oar in a ' +
        'slave galley.';
    } else if (roll <= 6) {
      ...
      return 'A romantic relationship ended. Roll 3d6. An odd number means it ended with bad feelings, while an even number means it ' +
        'ended amicably.';
    } else {
