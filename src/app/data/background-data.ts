export const CHAR_BACKGROUNDS = [
    {
        ...
        reasons: [
            ...
            'I grew up in a household with strong religious convictions. Entering the service ofone or more gods seemed natural.',
            ...
            'After encountering a true servant ofthe gods, l was so inspired that I immediately entered the service of a religious group.',
        ]
    },
    {
        label: 'Charlatan',
    ...
    },
    {
        ...
        reasons: [
            ...
            'A parent or one of my relatives was an adventurer, and l was inspired by that person’s courage.',
            'A mad old hermit spoke a prophecy when I was born, saying that I would accomplish great things.',
            'l have always stood up for those who are weaker than I am.',
        ]
    },
    {
        label: 'Guild Artisan',
    ...
    },
    {
        ...
        reasons: [
            ...
            'My people lived on the edges of civilization, and i learned the methods ofsurvival from my family.',
    ...
    },
    {
        ...
        reasons: [
            ...
            'I discovered an old library and pored over the texts I found there. That experience awakened a hunger I for more knowledge.',
    ...
    },
    {
        ...
        reasons: [
            ...
            'I needed to escape my community quickly, so I stowed away on a ship. When the crew found me, ' +
    ...
    },
    {
        ...
        reasons: [
            ...
            'A relative of mine was a soldier, and I wanted to i carry on the family tradition.',
    ...
    },
    {
        label: 'Urchin',
        reasons: [
            'Wanderlust caused me to leave my family to see the the world. I look after myself.',
